...
<template>
  <div class="flex h-screen max-w-[1280px] mx-auto">
    ...
    <main class="flex-1 flex flex-col h-dvh">
      <iframe src="https://66a25a092ad02d2c3fcdaaf4--adorable-blancmange-5da317.netlify.app/" class="bg-white m-6 focus:outline-none rounded-lg border-2 border-neutral-700"
