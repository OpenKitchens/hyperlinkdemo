...
<template>
  <div class="flex h-screen max-w-[1280px] mx-auto">
    ...
    <main class="flex-1 flex flex-col h-dvh">
      <iframe src="https://66a256731bacb93479816fe2--starlit-belekoy-647eb6.netlify.app/" class="bg-white m-6 focus:outline-none rounded-lg border-2 border-neutral-700"
