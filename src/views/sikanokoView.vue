...
<template>
  <div class="flex h-screen max-w-[1280px] mx-auto">
    ...
    <main class="flex-1 flex flex-col h-dvh">
      <iframe src="https://66a258cd63131c37d1b813d4--extraordinary-sprite-397e98.netlify.app/" class="bg-white m-6 focus:outline-none rounded-lg border-2 border-neutral-700"
        style="height: calc(100% - 3rem);width: calc(100% - 3rem)"></iframe>
    </main>

    <aside class="w-[28rem] h-dvh">
      <div class="mt-6">
        <Chat />
      </div>
      <div class="my-6 fixed bottom-0">
        <Vc class="w-[28rem]" />
      </div>
    </aside>
  </div>
